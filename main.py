...
if __name__ == '__main__':
    start = time.time_ns()
    testSpacyNLP(sample_text)
    end = time.time_ns()
    print('Dauer spaCy: ' + str(end - start))
    start = time.time_ns()
    testNLTK(sample_text)
    end = time.time_ns()
    print('Dauer NLTK: ' + str(end - start))